...
module.exports = client => {
  ...
  try{
    try{
      ...
      console.log(`     ┃ `.bold.grey + `Discord Bot is online!`.bold.grey + " ".repeat(-1+stringlength-` ┃ `.length-`Discord Bot is online!`.length)+ "┃".bold.grey)
      console.log(`     ┃ `.bold.grey + ` /--/ ${client.user.tag} /--/ `.bold.grey+ " ".repeat(-1+stringlength-` ┃ `.length-` /--/ ${client.user.tag} /--/ `.length)+ "┃".bold.grey)
      console.log(`     ┃ `.bold.grey + " ".repeat(-1+stringlength-` ┃ `.length)+ "┃".bold.grey)
      console.log(`     ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`.bold.grey)
    }catch{ /* */ }
